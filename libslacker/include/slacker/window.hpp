#ifndef SLACKER_WINDOW_HPP_
#define SLACKER_WINDOW_HPP_
...
public:
  ...
  SlackerWindow &operator=(const SlackerWindow &other) = default;
  SlackerWindow(SlackerWindow &&other) = default;
  SlackerWindow &operator=(SlackerWindow &&other) = default;
